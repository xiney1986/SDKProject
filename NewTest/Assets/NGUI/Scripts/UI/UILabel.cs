...
public class UILabel : UIWidget
{
	...
	protected override void OnInit ()
	{
		...
		if(trueTypeFont!=null && Application.platform!=RuntimePlatform.WindowsEditor && Application.platform!=RuntimePlatform.OSXEditor && GameManager.Instance!=null)
			trueTypeFont=GameManager.Instance.mainFont;
	...
	protected override void OnStart ()
	{
		...
		if(text.Length>1 && text.Substring(0,1)=="@" && GameManager.Instance!=null ){
			text=LanguageConfigManager.Instance.getLanguage(text.Substring(1,text.Length-1)).Replace("\\n", "\n");
		}

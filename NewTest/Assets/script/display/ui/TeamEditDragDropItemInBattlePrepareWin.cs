 ...
 * yxl
 */
public class TeamEditDragDropItemInBattlePrepareWin : UIDragDropItem 
{
	//public TeamViewInMissionWindow1 window;

	public BattlePrepareWindowNew window;
...
//		}
			...
			window.savingArmy = ArmyManager.Instance.ActiveEditArmy;

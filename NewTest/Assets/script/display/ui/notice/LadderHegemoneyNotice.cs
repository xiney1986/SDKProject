...
public class LadderHegemoneyNotice : Notice {

	public ActiveTime activeTime;
	
	public LadderHegemoneyNotice (int sid):base(sid) {
		this.sid = sid;
	}
	/** 是否有效 */
...
public class LadderHegemoneyActiveNotice : Notice {
	
	public ActiveTime activeTime;
	
	public LadderHegemoneyActiveNotice (int sid):base(sid) {
		this.sid = sid;
	}

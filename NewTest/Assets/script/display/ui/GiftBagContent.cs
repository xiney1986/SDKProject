...
public class GiftBagContent : ContentBase 
{
	private GiftBagContentWindow win;
	...
	{
		this.win = win as GiftBagContentWindow; 
		prizes = _prizes;
	}
	...
	public override void CreateButton (int index, GameObject page, int buttonIndex)
	{
		...
		button.initPrize(prizes[index],windowBack,win);
	...
	{
		UiManager.Instance.openWindow<GiftBagContentWindow> ();
	}
